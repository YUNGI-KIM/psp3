...
function QuestionPage() {
  ...
  const questions = [
    ...
    { num: "질문 8번", text: "차량 정비소를 자주 이용하십니까?", progress: "56%", yes: "korean", no: "foreign" },
    ...
    { num: "질문 11번", text: "가성비를 중요하게 생각하십니까?", progress: "77%", yes: "korean", no: "foreign" },
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full sm:max-w-2xl px-4 z-10">
        <div className="rounded-3xl p-12 bg-white shadow-xl">
          <div className="text-center space-y-8">
            ...
            <div className="flex justify-center space-x-4">
              <button
                ...
                className="py-2 px-4 flex justify-center items-center bg-green-500 hover:bg-green-700 text-white w-32 text-base font-semibold shadow-md rounded-full transition"
              >
                그렇다
              </button>
              ...
              <button
                ...
                className="py-2 px-4 flex justify-center items-center bg-red-500 hover:bg-red-700 text-white w-32 text-base font-semibold shadow-md rounded-full transition"
              >
                아니다
              </button>
            </div>
