...
function Support(){
    ...
    return (
        ...
        <div className="space-y-2 bg-gray-200 "> 
            ...
            <div class=" relative mr-33">
                <label for="name-with-label" class="px-10 text-gray-700">
                    상담 문의 내용 입력
                </label>
                <input type="text" id="name-with-label" class=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-100px py-30 px-6 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent" name="email" placeholder="문의하기"/>
            </div>
            <button
                onClick={() => navigate('/')}
                className="ml-65 px-4 py-2 bg-gray-200 hover:bg-gray-400 text-black rounded-lg text-base"
            >
                신청
            </button>
