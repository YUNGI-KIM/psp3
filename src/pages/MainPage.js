...
const MainPage = () => {
    ...
    return (
        <div
            className="flex flex-col w-full min-h-screen overflow-x-hidden bg-gradient-to-b from-[#f6fbff] via-[#eaf1ff] to-[#f8fbff]">
            ...
            <div className="relative w-full overflow-visible px-2 sm:px-4">
                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                    ...
                    <div className="relative w-screen h-[90vh] overflow-hidden">
                        ...
                        {/* 좌우 화살표 */}
                        <div className="absolute top-1/2 left-4 transform -translate-y-1/2 z-10">
                            <svg onClick={SlideToLeft} xmlns="http://www.w3.org/2000/svg" fill="none"
                                 viewBox="0 0 24 24" strokeWidth="4" stroke="currentColor"
                                 className="w-10 h-10 cursor-pointer hover:text-yellow-200 hover:scale-110 transition-transform">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5"/>
                            </svg>
                        </div>
                        <div className="absolute top-1/2 right-4 transform -translate-y-1/2 z-10">
                            <svg onClick={SlideToRight} xmlns="http://www.w3.org/2000/svg" fill="none"
                                 viewBox="0 0 24 24" strokeWidth="4" stroke="currentColor"
                                 className="w-10 h-10 cursor-pointer hover:text-yellow-200 hover:scale-110 transition-transform">
                    ...
                    {/* 브랜드 카드 슬라이드 (카드 섹션) */}
                    <div
                        className="w-full flex items-center justify-between px-2 sm:px-6 md:px-12 py-8 relative overflow-hidden">
                        {/* 왼쪽 화살표 */}
                        <button
                    ...
                    `}
                                    ...
                                    >
                                        <div
                                            className="relative flex items-center justify-center w-full h-16 sm:h-20 md:h-24">
                                            <img
                                                alt={logo.alt}
                                                src={logo.src}
                                                title={logo.alt}
