...
const IoniqSpecs = {
  priceAfterTax: "4,325 만원~",
  priceBeforeTax: "4,450 만원~",
  efficiency: "~3.1 km/kWh",
  displacement: " - ",
};
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">BongoEv</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="..//ImageSrc/Estimate/Kia/BongoEv/bongo-ev.png"
            alt="bongo-ev.png"
