...
const IoniqSpecs = {
  priceAfterTax: "3,668 만원~",
  priceBeforeTax: "3,768 만원~",
  efficiency: "~11.7 km/L",
  displacement: "~3470cc",
};

function HyundaiGrandeur() {
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          <span className="text-lg bg-blue-600 text-white px-4 py-1 rounded">세단</span>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">Grandeur</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="/ImageSrc/Estimate/Hyundai/Grandeur/Grandeur.png"
            alt="Grandeur"
...
export default HyundaiGrandeur;
