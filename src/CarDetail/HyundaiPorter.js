...
const IoniqSpecs = {
  priceAfterTax: "1,530 만원~",
  priceBeforeTax: "1,580 만원~",
  efficiency: "~9.9 km/L",
  displacement: "~2497cc",
};

function HyundaiPorter() {
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          <span className="text-lg bg-blue-600 text-white px-4 py-1 rounded">화물차</span>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">Porter</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="/ImageSrc/Estimate/Hyundai/Porter/porter.png"
            alt="Porter"
            className="max-w-full w-full md:max-w-[600px] h-auto"
          />
        </div>
      </div>
