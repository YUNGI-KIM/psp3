...
const IoniqSpecs = {
  ...
  priceBeforeTax: "3,100 만원~",
  efficiency: "~13.6 km/kWh",
  displacement: "~1598cc",
};
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">Arkana</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="../Image/Estimate/Renault/Arkana/Arkana.png"
            alt="Arkana"
