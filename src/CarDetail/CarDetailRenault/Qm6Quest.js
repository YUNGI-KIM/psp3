...
const IoniqSpecs = {
  priceAfterTax: "2,422 만원~",
  priceBeforeTax: "2,565 만원~",
  efficiency: "~9.9 km/kWh",
  displacement: "~1998cc",
};
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">Qm6Quest</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="../Image/Estimate/Renault/Qm6Quest/Qm6Quest.jpg"
            alt="Qm6Quest"
