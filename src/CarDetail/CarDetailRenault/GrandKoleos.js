...
const IoniqSpecs = {
  priceAfterTax: "3,442 만원~",
  priceBeforeTax: "3,598 만원~",
  efficiency: "~13.0 km/L",
  displacement: "~1969cc",
};

function GrandKoleos() {
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">GrandKoleos</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="../Image/Estimate/Renault/GrandKoleos/GrandKoleos.png"
            alt="GrandKoleos"
