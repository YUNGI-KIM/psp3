...
const IoniqSpecs = {
  priceAfterTax: "4,347 만원~",
  priceBeforeTax: "4,500 만원~",
  efficiency: "~13.4 km/L",
  displacement: "~2497cc",
};
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">G70</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="..//ImageSrc/Estimate/Genesis/G70/G70.png"
            alt="G70"
