...
const IoniqSpecs = {
  priceAfterTax: "5,298 만원~",
  priceBeforeTax: "5,580 만원~",
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row items-start justify-between mt-10 mb-0 bg-white px-6 md:px-12 py-6">
        ...
        <div className="flex-1 space-y-10">
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight break-keep">GV70</h1>
        ...
        <div className="flex-1 mt-12 md:mt-0 mb-0 flex justify-center">
          <img
            src="..//ImageSrc/Estimate/Genesis/GV70/GV70.png"
            alt="GV70"
